package com.example.vuongdoan.appmp3.adapter;
...
import com.example.vuongdoan.appmp3.activity.ActivityPlaySong;
import com.example.vuongdoan.appmp3.bean.Song;
...
public class AdapterSong extends RecyclerView.Adapter<AdapterSong.AdapSong> {
    ...
    @Override
    public AdapSong onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final AdapSong holder, int position) {
